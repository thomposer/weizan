...
if(!pdo_fieldexists('xcommunity_room', 'realname')) {
  pdo_query("ALTER TABLE ".tablename('xcommunity_room')."  ADD   `realname` varchar(20) DEFAULT NULL;");
}
if(!pdo_fieldexists('xcommunity_room', 'pid')) {
  pdo_query("ALTER TABLE ".tablename('xcommunity_room')."  ADD   `pid` varchar(20) DEFAULT NULL;");
}